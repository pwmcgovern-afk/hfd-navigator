...
const content = {
  ...
  es: {
    ...
    subtitle: 'Ayúdenos a mantener nuestro directorio actualizado. Envíe un nuevo recurso o sugiera actualizaciones a uno existente.',
    ...
    optional: 'Opcional',
    whatChanged: '¿Qué necesita ser actualizado?',
    submit: 'Enviar Sugerencia',
    submitting: 'Enviando...',
    success: '¡Gracias! Su sugerencia ha sido enviada para revisión.',
